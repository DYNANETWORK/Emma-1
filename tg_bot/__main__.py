...
PM_START_TEXT = f"""
Hey there! my name is  EMMA. [👿](https://telegra.ph/file/c99843090101ad3e730a9.jpg) If you have any questions on how to use me, Click /help.

Myself an Powerfull  group management bot.
...
❤️✗ 🛡[Updates Channel](t.me/tbhnetwork) 💙.

❤️✗ 🛡[ʙʟᴜᴇ Support Group](t.me/TBH_NETWORK)💙. ).
...
buttons += [
    [
        InlineKeyboardButton(
            text="Add to Group 👥", url="t.me/MISS_EMMA_ROBOT?startgroup=true"
        ),
...
def Shoko_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text="*ʙʟᴜᴇ is a bot for managing your group with additional features,*"
                 "\nand is fork of [marie](https://github.com/PaulSonOfLars/tgbot)."
                 "\n\n_ʙʟᴜᴇ's licensed under the GNU General Public License v3.0_,"
                 "\nhere is the [repository](https://github.com/aksr-aashish/akeno)."
                 "\n\nIf any question about ʙʟᴜᴇ, let us know at @TBH_NETWORK.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            text="*Basic help:*"
                 "\nTo add ʙʟᴜᴇ to your chats, simply click [here](http://t.me/MISS_EMMA_ROBOT?startgroup=true)  and select your chat."
                 "\nYou can also click on @MISS_EMMA_ROBOT, and go to the three dots on the top right of your screen, and select 'add to group'."
                 "",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[
        ...
        query.message.edit_text(
            text="<b>Terms and Conditions:</b>"
                 ...
                 "\n- If you need to ask anything about this bot, Go @TBH_NETWORK."
                 "\n- If you asking nonsense in @TBH_NETWORK, you will get banned."
                 "\n- Sharing any files/videos others than about bot in @TBH_NETWORK is prohibited."
                 "\n- Sharing NSFW in @TBH_NETWORK will reward you banned/gbanned and reported to Telegram as well."
                 "\n\nFor any kind of help, related to this bot, Join @TBH_NETWORK."
                 "\n\n<i>Terms and Conditions will be changed anytime</i>"
                 "\nFollow @TBH_NETWORK for Updates."
                 "\nFollow @TBH_NETWORK to get info about bots.",
            parse_mode=ParseMode.HTML,
